...
public class EnchantTargets {
    ...
    public static final List<Material> Weapons = Arrays.asList(
            Material.WOODEN_SWORD,
            Material.STONE_SWORD,
            Material.IRON_SWORD,
            Material.GOLDEN_SWORD,
    ...
    public static final List<Material> Chestplates = Arrays.asList(
    ...
    public static final List<Material> Leggings = Arrays.asList(
    ...
    public static final List<Material> EnchantableItems = Arrays.asList(
            Material.WOODEN_SWORD,
            Material.STONE_SWORD,
            Material.IRON_SWORD,
            Material.GOLDEN_SWORD,
